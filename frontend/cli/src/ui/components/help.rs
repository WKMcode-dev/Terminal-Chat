...
pub fn render_help(frame: &mut Frame, app: &App, theme: Theme) {
    ...
    let lines = vec![
        ...
        shortcut("/ ou Ctrl+F", "Busca usuários por nome ou @usuário em Perfis", theme),
        ...
        shortcut("Ctrl+Shift+Q", "Sai da conta e volta ao login", theme),
        shortcut("F5-F8", "Aliases opcionais para as quatro áreas", theme),
        Line::raw(""),
        Line::styled(
            "Comandos: /conversas  /canais  /perfis  /config  /ajuda  /sair  /quit",
